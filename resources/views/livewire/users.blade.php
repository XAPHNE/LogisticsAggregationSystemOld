<div>
    <title>LAST Dashboard - User management</title>
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
            <a href="{{route('user.add')}}" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
        ...
        <table class="table user-table table-hover align-items-center">
            <thead>
                <tr>
                    ...
                    <th class="border-bottom"><a wire:click="sortBy('first_name')" class="text-default me-3"><span>Name</span><span><i class="fas fa-sort-up"></i></span></a></th>
                    <th class="border-bottom"><a class="text-default me-3"><span>Role</span><span><i class="fas fa-sort"></i></span></a></th>
                    <th class="border-bottom"><a wire:click="sortBy('created_at')" class="text-default me-3"><span>Date Created<i class="fas fa-sort"></i></span></a></th>
            ...
            <tbody>
                @foreach ($users as $user)
                    <tr>
                        ...
                        <td><span class="fw-normal">{{ $user->roles->name }}</span></td>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu dashboard-dropdown dropdown-menu-start mt-2 py-1">
                                    <a class="dropdown-item d-flex align-items-center" href="{{ route('user.edit', ['id' => $user->id]) }}">
                                        <span class="fas fa-user-shield me-2"></span>
                                        View Details
                                    </a>
                                    <button type="button" class="dropdown-item text-danger d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#confirmDeleteModal" wire:click="confirmUserDeletion({{ $user->id }})">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <!-- Modify the "Delete" button to trigger Livewire deleteUser method -->
                        <button type="button" id="deleteUser" class="btn btn-danger" data-bs-dismiss="modal" wire:click="deleteUser">Delete</button>
