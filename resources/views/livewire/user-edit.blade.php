    ...
    <div class="col-12 col-xl-8">
        <div class="card card-body shadow-sm mb-4">
            <h2 class="h5 mb-4">User information</h2>
                <form wire:submit.prevent="updateUser" action="{{ route('user.edit', ['id' => $user->id]) }}" method="POST">
                    @csrf
                    ...
                    <div class="mt-3">
                        <button type="submit" class="btn btn-gray-800 mt-2 animate-up-2" id="userUpdate">Update</button>
                    </div>
                </form>
            </div>
        </div>
